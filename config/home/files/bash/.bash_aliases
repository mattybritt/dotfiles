...
alias dot="cd ~/git/github/mattybritt/dot"
alias k=kubectl
alias '?'=duck
alias '??'=google
alias '???'=bing
...
alias ..="cd .."
alias lsa="ls -la"
alias killomnisharp="fuser -k /home/mattb/omnisharp-roslyn/artifacts/publish/OmniSharp.Stdio.Driver/linux-x19/net6.0/OmniSharp"
